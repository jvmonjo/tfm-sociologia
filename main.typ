...
#show: book.with(
  ...
  author: "Josep Monjo",
  dedication: [_“Aquí la paraula ho és tot: és la nostra acció,
el nostre medi i el nostre fi"._ \ 
*Pasqual Maragall. \
...
#include {"capitols/02-conquesta.typ"}
#include {"capitols/03-minyons.typ"}
#include {"capitols/04-actualitat.typ"}
#include {"capitols/05-futur.typ"}
